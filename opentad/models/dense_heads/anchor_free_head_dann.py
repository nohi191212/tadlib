...
from ..bricks import ConvModule, Scale, GradientReversalLayer


@HEADS.register_module()
class AnchorFreeHeadDANN(nn.Module):
    def __init__(
        self,
        num_classes,
        num_domains,
        ...
        super(AnchorFreeHeadDANN, self).__init__()
    ...
    def forward_train(self, feat_list, mask_list, gt_segments, gt_labels, gt_domains, **kwargs):
        ...
        losses, pos_mask, gt_cls = self.losses(cls_pred, reg_pred, dom_pred, mask_list, points, gt_segments, gt_labels, gt_domains)
...
@HEADS.register_module()
class ActionFormerHeadDANN(AnchorFreeHeadDANN):
    def __init__(
        self,
        num_classes,
        num_domains,
