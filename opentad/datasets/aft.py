...
import json
import os
from .base import PaddingDataset, ResizeDataset
from .builder import DATASETS, get_class_index
from mmengine.dataset import Compose


@DATASETS.register_module()
class AFTPaddingDataset:
    def __init__(
        self,
        ...
        super(AFTPaddingDataset, self).__init__()
    ...
    def get_gt(self, video_info, thresh=0.0):
        ...
        gt_domain = [domain_map[video_info["subset"]]]
        ...
        if len(gt_segment) == 0:  # have no valid gt
            ...
            annotation = dict(
                ...
                gt_domains=np.array(gt_domain, dtype=np.int32),
            )
    ...
    def filter_same_annotation(self, annotation):
        gt_segments = []
        gt_labels = []
        for gt_segment, gt_label in zip(annotation["gt_segments"].tolist(), \
                            annotation["gt_labels"].tolist()):
        ...
        annotation = dict(
            ...
            gt_domains=annotation["gt_domains"],
        )
        return annotation
